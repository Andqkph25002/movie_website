...
<html lang="vi">
   <head>
      ...
      <link rel="shortcut icon" href="https://scontent.fhan2-4.fna.fbcdn.net/v/t39.30808-6/323140112_2128504504003443_8403396088588280489_n.jpg?stp=cp6_dst-jpg&_nc_cat=103&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=nX4RYfs-3XQAX-YpQr-&_nc_ht=scontent.fhan2-4.fna&oh=00_AfAOxMLfySQK1LVQ5SgnGXBbfgq527848Nxc9DKhQxLrtw&oe=642B2B7C" type="image/x-icon" />
      ...
      <style>#header .site-title {background: url(https://scontent.fhan2-4.fna.fbcdn.net/v/t39.30808-6/323140112_2128504504003443_8403396088588280489_n.jpg?stp=cp6_dst-jpg&_nc_cat=103&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=nX4RYfs-3XQAX-YpQr-&_nc_ht=scontent.fhan2-4.fna&oh=00_AfAOxMLfySQK1LVQ5SgnGXBbfgq527848Nxc9DKhQxLrtw&oe=642B2B7C) no-repeat top left;background-size: contain;text-indent: -9999px;}</style>
   </head>
   <body class="home blog halimthemes halimmovies" data-masonry="">
            ...
            <div class="row" id="headwrap">
               ...
               <div class="col-md-5 col-sm-6 halim-search-form hidden-xs">
                  <div class="header-nav">
                     <div class="col-xs-12">
                       <form id="search-form-pc" name="halimForm" role="search" action="{{ route('search.movie') }}" method="GET"> 
                     ...
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              ...
                              <li><a title="{{ $item->title }}" href="{{ route('genre' , $item->slug) }}">{{ $item->title }}</a></li>
                              @endforeach
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              ...
                              <li><a title="{{ $item->title }}" href="{{ route('country', $item->slug) }}">{{ $item->title }}</a></li>
                              @endforeach
                        ...
                        <li class="mega"><a title="{{ $item->title }}" href="{{ route('category' , $item->slug) }}">{{ $item->title }}</a></li>
                        @endforeach
            ...
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  <div class="footer-logo">
                     {{-- <img class="img-responsive" src="{{ asset('backend/assets/images/man.jpg') }}" alt="Phim hay 2021- Xem phim hay nhất" /> --}}
                     
                  </div>
                  Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">andqkph25002@fpt.edu.vn</a>
               </div>
            </div>
         </div>
      </footer>
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0" nonce="yws55VPj"></script>
            ...
            if(search != ''){
               ...
               $.getJSON('/json_file/movie.json' , function(data){
                    $.each(data , function(key , value){
                        if(value.title.search(expression) != -1 || value.english_title.search(expression) != -1){
                            $("#result").append('<li class="list-group-item" style="cursor:pointer"><img height="60" style="padding:10px" width="60" src="'+value.image+'" />'+value.title+'<br> | '+value.english_title+'</li>')
                        }
                    })
               })
            }else{
